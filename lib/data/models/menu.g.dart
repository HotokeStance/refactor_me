...
void _menuSerialize(
  ...
  writer.writeLongList(offsets[0], object.exerciseIds);
...
Menu _menuDeserialize(
  ...
  final object = Menu();
  object.exerciseIds = reader.readLongList(offsets[0]) ?? [];
  object.id = id;
...
extension MenuQueryFilter on QueryBuilder<Menu, Menu, QFilterCondition> {
  QueryBuilder<Menu, Menu, QAfterFilterCondition> exerciseIdsElementEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Menu, Menu, QAfterFilterCondition> exerciseIdsElementGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Menu, Menu, QAfterFilterCondition> exerciseIdsElementLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Menu, Menu, QAfterFilterCondition> exerciseIdsElementBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Menu, Menu, QAfterFilterCondition> exerciseIdsLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Menu, Menu, QAfterFilterCondition> exerciseIdsIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'exerciseIds',
        0,
  ...
  QueryBuilder<Menu, Menu, QAfterFilterCondition> exerciseIdsIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'exerciseIds',
        0,
  ...
  QueryBuilder<Menu, Menu, QAfterFilterCondition> exerciseIdsLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Menu, Menu, QAfterFilterCondition> exerciseIdsLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Menu, Menu, QAfterFilterCondition> exerciseIdsLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension MenuQueryWhereDistinct on QueryBuilder<Menu, Menu, QDistinct> {
  QueryBuilder<Menu, Menu, QDistinct> distinctByExerciseIds() {
    return QueryBuilder.apply(this, (query) {
...
extension MenuQueryProperty on QueryBuilder<Menu, Menu, QQueryProperty> {
  ...
  QueryBuilder<Menu, List<int>, QQueryOperations> exerciseIdsProperty() {
    return QueryBuilder.apply(this, (query) {
